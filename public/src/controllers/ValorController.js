    ...
    send(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userToSend = yield prisma.valor.findUnique({
                    //valor do send
                    where: { user: id },
                });
                ...
                const userToReceived = yield prisma.valor.findUnique({
                    //valor do received
                    where: { user: user },
                });
    ...
    myvalor(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield prisma.valor.findUnique({
                    //valor do user
                    where: { user },
