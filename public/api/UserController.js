    ...
    create(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const res = yield __1.prisma.user.findUnique({ where: { email } }); //faz busca no banco com o email
                if (!res == null) {
    ...
    valid(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const hash = yield __1.prisma.user.findUnique({
                    where: { email: email },
    ...
    googlevalid(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const user = yield __1.prisma.user.findUnique({ where: { email } }); //busca no banco
                if (!user) {
                    return response.status(401).json({ erro: "Usuário não encontrado" });
                }
                const data = jsonwebtoken_1.default.sign({ id: user.id, name: user.name }, "190526", {
