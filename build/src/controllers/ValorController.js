    ...
    edit(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield connect_1.prisma.valor.update({
                    where: { user },
    ...
    send(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userToSend = yield connect_1.prisma.valor.findUnique({
                    //valor do send
                    where: { user: id },
                });
                ...
                const userToReceived = yield connect_1.prisma.valor.findUnique({
                    //valor do received
                    where: { user: user },
                });
                ...
                yield connect_1.prisma.transaction.create({
    ...
    myvalor(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield connect_1.prisma.valor.findUnique({
                    //valor do user
                    where: { user },
